      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {cases.map((useCase, index) => (
            <div key={index} className="glass-card p-8 hover-glow transition-all duration-300 hover:scale-[1.02]">
              ...
              <button
                ...
                className="w-full bg-primary/10 hover:bg-primary hover:text-primary-foreground text-primary border border-primary/30 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2 group"
              >
        ...
        <div className="text-center mt-12">
          <button
            onClick={onBookCallClick}
            className="inline-flex items-center justify-center bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg transition-colors font-semibold rounded-full"
          >
