    ...
    <section id="services" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="glass-card p-8 text-center">
          <h3 className="text-2xl font-bold mb-6 gradient-text">See Your Business Transform</h3>
          <div className="relative max-w-4xl mx-auto mb-6">
            <img 
              src={dashboardPreview} 
              alt="Automation dashboard showing productivity metrics and workflows"
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            This is how your business will run smoother - unified dashboards, automated workflows, 
            and real-time insights that help you make better decisions faster.
          </p>
